...
- [docs/ec2.md](docs/ec2.md) — the application host: instance sizing, the reverse proxy, TLS and ACME, throttling, how a deploy reaches it, and how to test all of it locally
